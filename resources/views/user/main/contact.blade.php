        ...
        @if (session('createSuccess'))
                        <div class="col-3 offset-4">
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <i class="fa-solid fa-cloud-arrow-up"></i>  {{session('createSuccess')}}
        ...
        <div class="row px-xl-5">
            <div class="col-lg-7 mb-5">
                <div class="contact-form bg-light p-30">
                    <div id="success"></div>
                    <form name="sentMessage" id="contactForm" novalidate="novalidate" method="post" action="{{route('user#contactData')}}">
                        @csrf
            ...
            <div class="col-lg-5 mb-5">
                ...
                <div class="bg-light p-30 mb-3">
                    ...
                    <p class="mb-2"><i class="fa fa-envelope text-primary mr-3"></i>azinphyo@gmial.com</p>
