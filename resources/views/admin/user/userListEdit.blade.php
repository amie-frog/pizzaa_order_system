                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-title">
                            <h3 class="text-center title-2  fw-bold">Update User Info</h3>
                        </div>

                        <form action="{{route('admin#userListEdit',$user->id)}}" method="post" enctype="multipart/form-data">
                            @csrf
                         <div class="row">
                           ...
                           @endif
                            ...
                            <div class=" row col-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="cc-pament" name="name" type="text" value="{{old('name',$user->name)}}" class="form-control @error('name')
                                        is-invalid
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="cc-pament" name="email" type="text" value="{{old('email',$user->email)}}" class="form-control  @error('email')
                                   is-invalid
                                @enderror" aria-required="true" aria-invalid="false" placeholder="enter email@,com...">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="cc-pament" name="phone" type="text" value="{{old('phone',$user->phone)}}" class="form-control  @error('phone')
                                   is-invalid
                                ...
                                @enderror">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input id="cc-pament" name="" type="text" value="{{$user->role}}" class="form-control " aria-required="true" aria-invalid="false" disabled>
